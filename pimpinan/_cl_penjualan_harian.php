...
$pdf->Cell(23.5,0.7,"Laporan Penjualan Harian",0,10,'C');
$pdf->ln(1);
$pdf->SetX(11.5);
$pdf->SetFont('Times','B',10);

$pdf->ln(1);
$pdf->Cell(23.5,0.7,"Tanggal Faktur : ".$_GET['tanggal'],0,0,'C');
$pdf->ln(1);
$pdf->SetX(3);
$pdf->SetFont('Times','B',10);
...
$no=1;
     if(isset($_GET['tanggal'])){
        ...
        $view=mysql_query("select * from penjualan where tgl_faktur like '$cari' order by tgl_faktur");
...
if(isset($_GET['tanggal'])){
            $x=mysql_query("select sum(total) as total2 from penjualan where tgl_faktur='$cari' "); 
