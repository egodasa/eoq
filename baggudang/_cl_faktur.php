...
$pdf->SetX(10,8);            
$pdf->MultiCell(20.5,0.5,'Toko Amsterdam Game Shop',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'',0,'L');    
$pdf->SetFont('Times','B',10);
$pdf->SetX(9.5);
$pdf->MultiCell(19.10,0.5,'JL. Raya Balai Tangah - Sitangkai KM.1 Kapalo Labuah Tepi Selo - Lintau',0,'L');
$pdf->SetX(12.8);
...
$pdf->Cell(23.5,0.7,"Faktur Penjualan",0,10,'C');
$pdf->ln(1);
$pdf->SetX(11.5);
$pdf->SetFont('Times','B',10);
$pdf->Cell(5,0.7,"Tanggal : ".date("d/m/Y"),0,0,'C');
$pdf->ln(1);
$pdf->Cell(23.5,0.7,"No Faktur : ".$_GET['fak'],0,0,'C');
$pdf->ln(1);
$pdf->SetX(3);
$pdf->SetFont('Times','B',10);
...
$no=1;
     if(isset($_GET['fak'])){
        $cari=mysql_real_escape_string($_GET['fak']);
...
if(isset($_GET['fak'])){
            $x=mysql_query("select sum(total) as total2 from penjualan where no_faktur='$cari' "); 
